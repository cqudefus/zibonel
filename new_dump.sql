...
INSERT INTO `about_us` (`id`, `title`, `description`, `vision`, `mission`, `banner`) VALUES
	(1, 'radio zibonele 98.2 fm', 'Radio Zibonele 98.2 FM has got a very unique market; in the province of the Western Cape We are the only Community Radio Station that broadcast 80% of its programmes in IsiXhosa 24 hours a day in the Province. Level of education within the areas of our broadcast is relatively low, people tune in to our Radio Station as it is one of their powerful sources of information that is brought to them in language they understand. We structure our programmes to suit and appeal directly to this wonderful audience. <br><br>Our programmes rage from current affairs, Women issues, Magazine programmes, News, Music, Community Issues, etc. For the past decade, Radio Zibonele 98.2 FM has shown a huge growth as it comes at a number two in the province and number three countrywide. As a trusted medium of learning, Radio Zibonele Community broadcast engages and enriches the community through its distinctive programming.', 'Radio Zibonele strives to be the best community radio station in the peninsula region, responsive to community needs and development through public broadcasting.<br><br>Radio Zibonele strives to be the best community radio station in the peninsula region, responsive to community needs and development through public broadcasting.<br>', 'As a trusted catalyst for lifelong learning, Radio Zibonele public broadcasting engages and enriches our community through distinctive programmes and services .<br><br>As a trusted catalyst for lifelong learning, Radio Zibonele public broadcasting engages and enriches our community through distinctive programmes and services .<br>', '');
/*!40000 ALTER TABLE `about_us` ENABLE KEYS */;

-- Dumping structure for table zibonale.athi
CREATE TABLE IF NOT EXISTS `athi` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table zibonale.athi: ~0 rows (approximately)
/*!40000 ALTER TABLE `athi` DISABLE KEYS */;
INSERT INTO `athi` (`id`, `name`, `other_name`) VALUES
	(1, 'Athi ', 'First article');
/*!40000 ALTER TABLE `athi` ENABLE KEYS */;
...
INSERT INTO `broadcasts` (`bc_id`, `bc_name`, `bc_description`, `bc_icon`) VALUES
	(1, 'Umyalezo Wosuku', 'Also see unicast, multicast, and anycast. In general, to broadcast (verb) is to cast or throw forth something in all directions at the same time. A radio or television broadcast (noun) is a program that is transmitted over airwaves for public reception by anyone with a receiver tuned to the right signal channel.', 'young-radio-announcer.jpg'),
	(2, 'Ilitha Lakho Breakfastshow', 'Also see unicast, multicast, and anycast. In general, to broadcast (verb) is to cast or throw forth something in all directions at the same time. A radio or television broadcast (noun) is a program that is transmitted over airwaves for public reception by anyone with a receiver tuned to the right signal channel.', 'radio-studi-microphones.jpg'),
...
INSERT INTO `contacts` (`id`, `cellphone`, `tell`, `email`, `street_name`, `suburb_name`, `street_number`, `facebook`, `twitter`, `instagram`, `google`, `youtube`) VALUES
	(1, '021812569', '021812569', 'berlmh@gamial.com', 'Suite 600', 'northern Surburbgggg', 'Suite 600', 'https://www.facebook.com/programmingcodes', 'https://twitter.com/', 'gg', 'https://plus.google.com/', 'https://www.youtube.com/channel/UC7KlcAfJ4AhHmVVpVkPlpMg');
...
-- Dumping structure for table zibonale.events
CREATE TABLE IF NOT EXISTS `events` (
  `id` int(15) NOT NULL AUTO_INCREMENT,
  `event_name` varchar(200) DEFAULT '0',
  `event_title` varchar(200) DEFAULT '0',
  `event_description` varchar(200) DEFAULT '0',
  `event_date` varchar(200) DEFAULT '0',
  `event_location` varchar(200) DEFAULT '0',
  `event_tickets` int(15) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table zibonale.events: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `gallery` (
  ...
  `image_description` varchar(200) DEFAULT '0',
  `image_file` longblob,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table zibonale.gallery: ~0 rows (approximately)
...
-- Dumping data for table zibonale.news: ~8 rows (approximately)
...
-- Dumping data for table zibonale.presenters: ~4 rows (approximately)
...
-- Dumping data for table zibonale.staffs: ~4 rows (approximately)
...
-- Dumping data for table zibonale.users: ~6 rows (approximately)
...
INSERT INTO `users` (`user_id`, `user_name`, `user_lastname`, `user_fullname`, `user_ref_role`, `user_cellphone`, `user_email`, `user_password`) VALUES
	(1, 'berkaPhp', 'berkaPhp', 'berkaPhp-small php', 2, NULL, 'admin@gmail.com', '1234'),
	(2, 'berka', 'ayowa', 'berka ayowa', 1, '0717253112', 'dev@gmail.com', '1234'),
	(3, 'lux', 'luxolo', 'tonton bukasa', 3, '644908043', 'tonton202017@gmail.com', '1234'),
	(4, 'Rev', 'Vellem', 'Rev Vellem', 3, NULL, '', ''),
	(5, 'Zweli ', 'Nokhatywa ', 'Zweli Nokhatywa ', 3, NULL, '', ''),
	(6, 'Roger', 'Skade', 'Roger Skade', 3, NULL, '', '');
